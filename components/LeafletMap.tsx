...
export const LANDMARKS = [
  ...
  { id: 6, name: "Left Hand Brewing", category: "dining", position: [40.1585, -105.1154], description: "Local tasting room.", address: "1265 Boston Ave" },
  ...
  { id: 9, name: "Blue Mountain Elementary", category: "schools", position: [40.1508, -105.1265], description: "Top-rated elementary.", address: "1260 Mountain Drive" },
